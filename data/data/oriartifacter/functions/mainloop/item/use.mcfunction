...
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:1504}}},scores={ART.atkd=3..}] run function oriartifacter:mainloop/item/base/atkd/4
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:2004}}},scores={ART.mana=3..}] run function oriartifacter:mainloop/item/base/mana/4
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:2504}}},scores={ART.hp=3..}] run function oriartifacter:mainloop/item/base/hp/4
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:3004}}},scores={ART.luck=3..}] run function oriartifacter:mainloop/item/base/luck/4

execute as @s[nbt={SelectedItem:{tag:{CustomModelData:505}}},scores={ART.spd=4..}] run function oriartifacter:mainloop/item/base/spd/5
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:1005}}},scores={ART.atks=4..}] run function oriartifacter:mainloop/item/base/atks/5
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:1505}}},scores={ART.atkd=4..}] run function oriartifacter:mainloop/item/base/atkd/5
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:2005}}},scores={ART.mana=4..}] run function oriartifacter:mainloop/item/base/mana/5
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:2505}}},scores={ART.hp=4..}] run function oriartifacter:mainloop/item/base/hp/5
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:3005}}},scores={ART.luck=4..}] run function oriartifacter:mainloop/item/base/luck/5

execute as @s[nbt={SelectedItem:{tag:{CustomModelData:506}}},scores={ART.spd=5..}] run function oriartifacter:mainloop/item/base/spd/6
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:1006}}},scores={ART.atks=5..}] run function oriartifacter:mainloop/item/base/atks/6
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:1506}}},scores={ART.atkd=5..}] run function oriartifacter:mainloop/item/base/atkd/6
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:2006}}},scores={ART.mana=5..}] run function oriartifacter:mainloop/item/base/mana/6
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:2506}}},scores={ART.hp=5..}] run function oriartifacter:mainloop/item/base/hp/6
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:3006}}},scores={ART.luck=5..}] run function oriartifacter:mainloop/item/base/luck/6

execute as @s[nbt={SelectedItem:{tag:{CustomModelData:507}}},scores={ART.spd=6..}] run function oriartifacter:mainloop/item/base/spd/7
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:1007}}},scores={ART.atks=6..}] run function oriartifacter:mainloop/item/base/atks/7
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:1507}}},scores={ART.atkd=6..}] run function oriartifacter:mainloop/item/base/atkd/7
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:2007}}},scores={ART.mana=6..}] run function oriartifacter:mainloop/item/base/mana/7
