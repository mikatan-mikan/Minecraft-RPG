...
scoreboard players add @p 5lvCount 1
scoreboard players add @p manaxp 1
...
##専用アクセサリー
execute as @p if entity @s[nbt={Inventory:[{"Slot":9b,id:"minecraft:magma_cream",tag:{CustomModelData:85}}]}] run scoreboard players add @s manaxp 1
##lvup
