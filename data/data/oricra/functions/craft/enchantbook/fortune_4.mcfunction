...
#アイテム
item replace block ~ ~ ~ container.4 with minecraft:enchanted_book{StoredEnchantments:[{id:"minecraft:fortune",lvl:4s}]} 1
...
execute if score @p farming_judge_bool matches 1 run function oricra:craft/enchantbook/farming/fortune_5
