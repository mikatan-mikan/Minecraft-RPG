...
execute as @a run give @s minecraft:carrot_on_a_stick{CustomModelData:66,display:{Name:'[{"text":"テレポート->","color":"aqua"},{"text": "【超高難易度】","color": "red"},{"text":"<<略奪者を追いかけた先に>>","color":"green"}]',Lore:['[{"text":"このアイテムを右クリックでディメンション移動を行います","color":"aqua"}]','[{"text":"移動先:ダンジョン","color":"red"}]','[{"text":"必要条件:AllLv95.."}]']}} 2
...
tellraw @a [{"text": "略奪者を追いかけた先に * 8","color": "yellow"}]
