summon skeleton -120 72 190 {Attributes:[{Name:"minecraft:generic.knockback_resistance",Base:0.5},{Name:"minecraft:generic.armor",Base:10},{Name:"minecraft:generic.max_health",Base:400},{Name:"minecraft:generic.attack_damage",Base:40}],Health:400,Tags:["SecondDunBoss","SecDunMob"]}
