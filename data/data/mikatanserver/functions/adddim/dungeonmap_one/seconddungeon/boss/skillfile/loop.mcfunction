...
execute at @s as @e[distance=..1,type=!armor_stand] if entity @s[tag=!TwentysevenDunBoss] at @s run function mikatanserver:adddim/dungeonmap_one/seconddungeon/boss/skillfile/executation
