...
execute as @s[tag=!FiveMThanHigh] at @s if entity @a[tag=DungeonPlay_2,distance=5..10] run data merge entity @s {HandItems:[{id:"minecraft:bow",Count:1b,tag:{Enchantments:[{id:"minecraft:power",lvl:15},{id:"minecraft:punch",lvl:2}]}}]}
