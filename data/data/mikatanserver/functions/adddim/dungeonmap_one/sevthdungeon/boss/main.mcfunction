execute in mikatanserver:dungeon run summon vindicator -353.0 64 34.0 {Attributes:[{Name:"minecraft:generic.knockback_resistance",Base:0.5},{Name:"minecraft:generic.armor",Base:6},{Name:"minecraft:generic.max_health",Base:350},{Name:"minecraft:generic.attack_damage",Base:25}],Health:350,Tags:["SevthDunBoss","SevDunMob"]}
