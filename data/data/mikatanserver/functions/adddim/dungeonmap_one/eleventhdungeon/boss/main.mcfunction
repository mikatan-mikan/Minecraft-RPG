##初期呼び出し
execute in mikatanserver:dungeon run summon skeleton -143.5 100 -195.5 {CustomNameVisible:1,Glowing:1,Health:1200,Attributes:[{Name:"minecraft:generic.max_health",Base:1200},{Name:"minecraft:generic.follow_range",Base:50},{Name:"minecraft:generic.knockback_resistance",Base:1d},{Name:"minecraft:generic.movement_speed",Base:1d},{Name:"minecraft:generic.attack_damage",Base:18}],Tags:["EleventhDunBoss","ElevenDunMob"]}
...
bossbar set minecraft:eleventhboss_bar max 1200
