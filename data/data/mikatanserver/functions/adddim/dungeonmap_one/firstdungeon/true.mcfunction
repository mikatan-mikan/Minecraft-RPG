...
bossbar remove minecraft:firstboss_bar
scoreboard players add @a[tag=DungeonPlay_1] DungeonClear_Num 3
execute as @a[tag=DungeonPlay_1] run function mikatanserver:adddim/dungeonmap_one/atks_xp
...
tag @a[tag=DungeonPlay_1] add Return_Dun_1
scoreboard players set $1 dungeon_play_now 0
scoreboard players add $1_Clear ClearPer 1
