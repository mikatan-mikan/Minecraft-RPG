summon zombie 69 74 -23 {Attributes:[{Name:"minecraft:generic.max_health",Base:400},{Name:"minecraft:generic.attack_damage",Base:10}],Health:400,Tags:["FirstDunBoss","FirDunMob"]}
bossbar add firstboss_bar "Atrus"
bossbar set minecraft:firstboss_bar players @a[tag=DungeonPlay_1]
bossbar set minecraft:firstboss_bar max 400
