...
give @a[tag=DungeonPlay_15] minecraft:chest{display:{Name:'[{"text":"ダンジョンドロップ","color":"green"},{"text":" - ","color":"yellow"},{"text":"溶岩流から生まれるもの","color":"red"}]'},BlockEntityTag:{LootTable:"mikatanserver:dungeon/fifteen_dungeon/boss/boss"}}
