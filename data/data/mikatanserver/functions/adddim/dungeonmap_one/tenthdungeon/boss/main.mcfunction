##初期呼び出し
execute in mikatanserver:dungeon run summon iron_golem -143.5 100 -195.5 {CustomNameVisible:1,Glowing:1,Health:700,Attributes:[{Name:"minecraft:generic.max_health",Base:700},{Name:"minecraft:generic.follow_range",Base:50},{Name:"minecraft:generic.knockback_resistance",Base:1d},{Name:"minecraft:generic.movement_speed",Base:0.8d},{Name:"minecraft:generic.attack_damage",Base:15}],Tags:["TenthDunBoss","TenDunMob","Dungeon_Boss"]}
