##初期呼び出し
execute in mikatanserver:dungeon run summon armor_stand 213.5 64 89.0 {Invulnerable:1b,NoBasePlate:1b,ShowArms:1b,Tags:["TwelvethDunBoss","TwelveDunMob","Non_HPBar","Dungeon_Boss"],DisabledSlots:4144959,Pose:{LeftArm:[305f,0f,318f],RightArm:[305f,0f,42f]},ArmorItems:[{Count:1b,id:"minecraft:leather_boots",tag:{display:{color:12458239},Enchantments:[{id:"minecraft:protection",lvl:4}],Unbreakable:1b}},{Count:1b,id:"minecraft:leather_leggings",tag:{display:{color:12458239},Enchantments:[{id:"minecraft:protection",lvl:4}],Unbreakable:1b}},{Count:1b,id:"minecraft:leather_chestplate",tag:{display:{color:12458239},Enchantments:[{id:"minecraft:protection",lvl:4}],Unbreakable:1b}},{Count:1b,id:"minecraft:player_head",tag:{SkullOwner:{Id:[I;1741307386,-304331284,-1350857045,789912679],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNWYxZmRlYjE0YThiN2E5NWU2MWYwODBhYWY5MWQyZDYyMWI2MjFjM2JlMzhlMjJlZWEwZjY4ZWQ4ZjJiMTMxMiJ9fX0="}]}}}}],HandItems:[{},{Count:1b,id:"minecraft:iron_sword"}],Health:1024,Attributes:[{Name:"minecraft:generic.max_health",Base:1024}]}
...
scoreboard players operation player 12DunPlayers *= $190 int
