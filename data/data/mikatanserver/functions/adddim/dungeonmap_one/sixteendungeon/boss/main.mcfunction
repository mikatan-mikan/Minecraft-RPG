##初期呼び出し
execute in mikatanserver:dungeon run summon armor_stand 125.5 61 1100.5 {Invulnerable:1b,NoBasePlate:1b,ShowArms:1b,Tags:["SixteenDunBoss","SixteenDunMob"],DisabledSlots:4144959,Pose:{LeftArm:[305f,0f,318f],RightArm:[305f,0f,42f]},ArmorItems:[{Count:1b,id:"minecraft:leather_boots",tag:{display:{color:15000804},Enchantments:[{id:"minecraft:protection",lvl:4}],Unbreakable:1b}},{Count:1b,id:"minecraft:leather_leggings",tag:{display:{color:15000804},Enchantments:[{id:"minecraft:protection",lvl:4}],Unbreakable:1b}},{Count:1b,id:"minecraft:leather_chestplate",tag:{display:{color:15000804},Enchantments:[{id:"minecraft:protection",lvl:4}],Unbreakable:1b}},{Count:1b,id:"minecraft:player_head",tag:{SkullOwner:{Id:[I;880142347,936595364,-1437289694,1597892970],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTRiNTlkMTExZGUwMGJkMTA0OGUzYmQ2ZjhhYmVlNmRmYzZkOWQ2NDg4MmU5ZmY3MzQ5NDZkNmJkMDQ3ZTMwZiJ9fX0="}]}}}}],HandItems:[{},{Count:1b,id:"minecraft:diamond_sword"}],Health:1024,Attributes:[{Name:"minecraft:generic.max_health",Base:1024}]}
