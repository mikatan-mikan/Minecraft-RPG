...
execute as @a[tag=DungeonPlay_19] at @s run summon armor_stand ~ ~ ~ {Small:1b,NoAI:1b,NoGravity:1b,Invisible:1b,Invulnerable:1b,Tags:["NineteenDunMob","NineteenBombAndMobAr"]}
