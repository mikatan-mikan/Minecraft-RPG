...
execute in mikatanserver:dungeon if score $32_Difficulty Temporary matches 1 run summon slime 1654.5 203 -433.5 {Attributes:[{Name:"minecraft:generic.knockback_resistance",Base:1.0},{Name:"minecraft:generic.max_health",Base:1024},{Name:"minecraft:generic.attack_damage",Base:10},{Name:"minecraft:generic.movement_speed",Base:0.38},{Name:"minecraft:generic.follow_range",Base:30}],Health:1024,Tags:["ThirtytwoDunBoss","ThirtytwoDunMob","Non_HPBar","Dungeon_Boss"],Silent:1b,CustomName:'[{"text": "Mods Slime","color": "green"}]',Rotation:[-135.0f,0.0f],Size:17,PersistenceRequired:true}

execute in mikatanserver:dungeon if score $32_Difficulty Temporary matches 2 run summon slime 1654.5 203 -433.5 {Attributes:[{Name:"minecraft:generic.knockback_resistance",Base:1.0},{Name:"minecraft:generic.max_health",Base:1024},{Name:"minecraft:generic.attack_damage",Base:20},{Name:"minecraft:generic.movement_speed",Base:0.38},{Name:"minecraft:generic.follow_range",Base:15}],Health:1024,Tags:["ThirtytwoDunBoss","ThirtytwoDunMob","Non_HPBar","Dungeon_Boss"],Silent:1b,CustomName:'[{"text": "Mods Slime","color": "green"}]',Rotation:[-135.0f,0.0f],Size:20,PersistenceRequired:true}
...
bossbar add thirtytwoboss_bar "Mods Slime"
