...
scoreboard players operation @s manaxp += $xp TMP
...
scoreboard players operation $xp TMP *= $leveling_xp TMP
scoreboard players operation @s hpxp += $xp TMP
...
scoreboard players operation $xp TMP *= $leveling_xp TMP
scoreboard players operation @s attackDxp += $xp TMP
...
scoreboard players operation $xp TMP *= $leveling_xp TMP
scoreboard players operation @s attackSxp += $xp TMP
...
scoreboard players operation $xp TMP *= $leveling_xp TMP
scoreboard players operation @s luckxp += $xp TMP
...
scoreboard players operation $xp TMP *= $leveling_xp TMP
scoreboard players operation @s speedxp += $xp TMP
