...
give @a[tag=DungeonPlay_23] minecraft:chest{display:{Name:'[{"text":"ダンジョンドロップ","color":"green"},{"text":" - ","color":"yellow"},{"text":"その彗星は瞬きのように・・・","color":"aqua"}]'},BlockEntityTag:{LootTable:"mikatanserver:dungeon/twentythree_dungeon/boss/boss"}}
