...
execute as @e[tag=season2Dun_Witch_Ar,sort=nearest,limit=1] at @s run function mikatanserver:adddim/dungeon_season/season2dungeon/0/skill/rand_pattern_2/summon/masic/move_ar