...
summon armor_stand ~ ~ ~ {Tags:["season2Dun_Witch_Ar","TagBefAr"],Small:1b,Invisible:1b,Invulnerable:1b,DisabledSlots:4144959}
...
execute as @e[tag=season2Dun_Witch_Ar,sort=nearest,limit=1] at @s run function mikatanserver:adddim/dungeon_season/season2dungeon/7/skill/rand_pattern_2/summon/masic/move_ar