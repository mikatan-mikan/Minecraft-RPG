...
playsound block.wool.place master @a[tag=DungeonPlay_season2,distance=..30] ~ ~ ~ 2 0
tellraw @a[tag=DungeonPlay_season2] [{"text": "Venus              >>","color": "dark_green"},{"text": "女神の舞！！","color": "gold"}]