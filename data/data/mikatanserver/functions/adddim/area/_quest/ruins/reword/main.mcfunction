...
execute if score @s QUEST_RUINS_LEVEL matches 15 run give @s minecraft:player_head{display:{Name:'[{"text":"enchant box","color": "red"}]',Lore:['{"text":"スメルティングⅠⅠⅠ","color": "gray","bold": false,"italic": false}','[{"text":" SpdXp対象ブロック採掘時に40%でブロックを焼いた状態で排出する","color": "blue","bold": false,"italic": false}]']},SkullOwner:{Id:[I;-1387993770,402933672,-1114672654,1138218237],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYWVhZTZmZTE4ZjI3YmJiM2I2MmEwM2U3YzBkYTJhM2Q4OGQzMGI2NTUwOThmZWIzNzdhMzJmNjcyZTMzYjdmNCJ9fX0="}]}},SmeltingLv:3} 1


execute if score @s QUEST_RUINS_LEVEL matches 25 run give @s minecraft:player_head{display:{Name:'[{"text":"enchant box","color": "red"}]',Lore:['{"text":"スメルティングⅠⅤ","color": "gray","bold": false,"italic": false}','[{"text":" SpdXp対象ブロック採掘時に40%でブロックを焼いた状態で排出する","color": "blue","bold": false,"italic": false}]']},SkullOwner:{Id:[I;-1387993770,402933672,-1114672654,1138218237],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYWVhZTZmZTE4ZjI3YmJiM2I2MmEwM2U3YzBkYTJhM2Q4OGQzMGI2NTUwOThmZWIzNzdhMzJmNjcyZTMzYjdmNCJ9fX0="}]}},SmeltingLv:4} 1
