...
execute as @e[scores={removesapAr=100..},tag=Area_mine_oak] at @s run function mikatanserver:adddim/area/island/blocks/ore/put_oak
execute as @e[scores={removesapAr=100..},tag=Area_mine_doak] at @s run function mikatanserver:adddim/area/island/blocks/ore/put_doak
execute as @e[scores={removesapAr=100..},tag=Area_mine_amethyst] at @s run function mikatanserver:adddim/area/island/blocks/ore/put_amethyst
...
execute as @s[scores={oakselfcount=1..}] at @s if entity @e[type=item,limit=1,sort=nearest,nbt={Item:{id:"minecraft:oak_log",Count:1b}},distance=..5] run give @s oak_wood{display:{Name:'[{"text":"islands planks","color": "green"}]'},island_item:true}
execute as @s[scores={oakselfcount=1..}] at @s if entity @e[type=item,limit=1,sort=nearest,nbt={Item:{id:"minecraft:oak_log",Count:1b}},predicate=mikatanserver:chance/0.30,distance=..5] run give @s oak_wood{display:{Name:'[{"text":"islands planks","color": "green"}]'},island_item:true}
execute as @s[scores={oakselfcount=1..}] at @s if entity @e[type=item,limit=1,sort=nearest,nbt={Item:{id:"minecraft:oak_log",Count:1b}},predicate=mikatanserver:chance/0.30,distance=..5] run give @s oak_wood{display:{Name:'[{"text":"islands planks","color": "green"}]'},island_item:true}
execute as @s[scores={oakselfcount=1..}] at @s if entity @e[type=item,limit=1,sort=nearest,nbt={Item:{id:"minecraft:oak_log",Count:1b}},predicate=mikatanserver:chance/0.30,distance=..5] run give @s oak_wood{display:{Name:'[{"text":"islands planks","color": "green"}]'},island_item:true} 1
...
execute as @s[scores={doakselfcount=1..}] at @s if entity @e[type=item,limit=1,sort=nearest,nbt={Item:{id:"minecraft:dark_oak_log",Count:1b}},predicate=mikatanserver:chance/0.30,distance=..5] run give @s oak_wood{display:{Name:'[{"text":"islands planks","color": "green"}]'},island_item:true} 1
execute as @s[scores={doakselfcount=1..}] at @s if entity @e[type=item,limit=1,sort=nearest,nbt={Item:{id:"minecraft:dark_oak_log",Count:1b}},predicate=mikatanserver:chance/0.30,distance=..5] run give @s oak_wood{display:{Name:'[{"text":"islands planks","color": "green"}]'},island_item:true} 1
execute as @s[scores={doakselfcount=1..}] at @s if entity @e[type=item,limit=1,sort=nearest,nbt={Item:{id:"minecraft:dark_oak_log",Count:1b}},predicate=mikatanserver:chance/0.30,distance=..5] run give @s oak_wood{display:{Name:'[{"text":"islands planks","color": "green"}]'},island_item:true} 1
