...
data modify entity @e[type=armor_stand,tag=DesertField_Ar,tag=Rank3,limit = 1] CustomName set from entity @e[nbt={Item:{tag:{Tags:["RankStore"]}}},limit=1] Item.tag.display.Name
kill @e[nbt={Item:{tag:{Tags:["RankStore"]}}}]
execute if score $rank3 TMP matches 2000000000.. run data modify entity @e[type=armor_stand,tag=DesertField_Ar,tag=Rank3,limit = 1] CustomName set value '[{"text":"None","color":"gray"}]'
...
execute in mikatanserver:dungeon if score $s TMP matches ..9 if score $t TMP matches 10.. run loot spawn -2300.5 140 933.5 loot mikatanserver:_system/parkour/rank0_
execute in mikatanserver:dungeon if score $s TMP matches ..9 if score $t TMP matches ..9 run loot spawn -2300.5 140 933.5 loot mikatanserver:_system/parkour/rank00
data modify entity @e[type=armor_stand,tag=DesertField_Ar,tag=Rank2,limit = 1] CustomName set from entity @e[nbt={Item:{tag:{Tags:["RankStore"]}}},limit=1] Item.tag.display.Name
kill @e[nbt={Item:{tag:{Tags:["RankStore"]}}}]
execute if score $rank2 TMP matches 2000000000.. run data modify entity @e[type=armor_stand,tag=DesertField_Ar,tag=Rank2,limit = 1] CustomName set value '[{"text":"None","color":"gray"}]'
...
execute in mikatanserver:dungeon if score $s TMP matches ..9 if score $t TMP matches 10.. run loot spawn -2300.5 140 933.5 loot mikatanserver:_system/parkour/rank0_
execute in mikatanserver:dungeon if score $s TMP matches ..9 if score $t TMP matches ..9 run loot spawn -2300.5 140 933.5 loot mikatanserver:_system/parkour/rank00
data modify entity @e[type=armor_stand,tag=DesertField_Ar,tag=Rank1,limit = 1] CustomName set from entity @e[nbt={Item:{tag:{Tags:["RankStore"]}}},limit=1] Item.tag.display.Name
kill @e[nbt={Item:{tag:{Tags:["RankStore"]}}}]
execute if score $rank1 TMP matches 2000000000.. run data modify entity @e[type=armor_stand,tag=DesertField_Ar,tag=Rank1,limit = 1] CustomName set value '[{"text":"None","color":"gray"}]'
