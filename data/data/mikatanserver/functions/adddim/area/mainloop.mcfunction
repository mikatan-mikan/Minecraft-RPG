...
execute if entity @a[tag=FieldIsland,scores={LogCheck_Timer=600..}] run function mikatanserver:adddim/area/island/mainloop
execute if entity @a[tag=FieldHalloween,scores={LogCheck_Timer=600..}] run function mikatanserver:adddim/area/halloween/mainloop