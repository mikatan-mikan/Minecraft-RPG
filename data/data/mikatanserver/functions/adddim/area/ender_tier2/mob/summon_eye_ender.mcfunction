...
## 座標代入及びタグの決定
summon enderman 243.5 74 -385.5 {Tags:["Field_TagBefEnder","eye_ender"],DeathLootTable:"mikatanserver:area/ender_tier2/eye_enderman",PersistenceRequired:true,carriedBlockState:{Name:"minecraft:end_portal_frame"},Attributes:[{Name:"minecraft:generic.max_health",Base:1}]}
