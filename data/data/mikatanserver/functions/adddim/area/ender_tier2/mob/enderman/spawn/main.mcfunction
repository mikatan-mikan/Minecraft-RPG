...
## 座標代入及びタグの決定
summon enderman 243.5 74 -385.5 {Tags:["Field_TagBefEnder"],DeathLootTable:"mikatanserver:area/ender_tier2/enderman",Attributes:[{Name:"minecraft:generic.max_health",Base:10}],CustomName:'[{"text": "zealot"}]'}
