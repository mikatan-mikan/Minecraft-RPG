...
execute as @e[type=armor_stand,distance=..6,tag=giantkillarAr] as @e[distance=..3.5,type=#mikatanserver:mobs] store result entity @s Health float 1 run scoreboard players get @s MobNowHP
