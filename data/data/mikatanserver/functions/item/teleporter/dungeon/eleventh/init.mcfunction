...
execute unless entity @s[tag=DungeonStart11] in mikatanserver:dungeon unless entity @a[tag=DungeonPlay_10] run function mikatanserver:adddim/dungeonmap_one/eleventhdungeon/start