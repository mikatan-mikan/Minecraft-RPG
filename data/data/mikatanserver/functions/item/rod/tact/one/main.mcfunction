...
execute as @e[tag=ZomAllies] at @s run tag @e[tag=!ZomAllies,type=!player,type=!item,type=!item_frame,type=!armor_stand,limit=1,sort=nearest,distance=..10] add EnemyMobChecker
