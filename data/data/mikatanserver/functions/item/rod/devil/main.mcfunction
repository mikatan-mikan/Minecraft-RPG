...
#devil一式なら
execute if entity @s[nbt={Inventory:[{Slot:100b,tag:{armor_devil:1b}},{Slot:101b,tag:{armor_devil:1b}},{Slot:102b,tag:{armor_devil:1b}},{Slot:103b,tag:{armor_devil:1b}}]}] run function mikatanserver:item/rod/devil/devil_full/mana
