...
execute as @e[distance=..1,type=#mikatanserver:mobs] at @s run function mikatanserver:item/rod/through_2/damageexe
...
execute if score @s NBthroughSwordTimer matches ..40 run schedule function mikatanserver:item/rod/through_2/move 1t