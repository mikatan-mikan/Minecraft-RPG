...
## 座標代入及びタグの決定
execute store result entity @s Pos[0] double 0.1 run scoreboard players get @s NowPlaceX
execute store result entity @s Pos[2] double 0.1 run scoreboard players get @s NowPlaceY
tag @s remove TpBef